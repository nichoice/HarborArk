...
var index$4 = require('../_chunks/dep-a4a942c3.js');
var loading_loading = require('../_chunks/dep-c4d37559.js');
var index$3 = require('../_chunks/dep-2e137265.js');
...
var _ImageViewer = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var images = Vue.computed(function () {
      return imageViewer_utils_index.formatImages(props2.images);
    });
    ...
    var onDownloadClick = function onDownloadClick(url) {
      props2.onDownload ? props2.onDownload(url) : imageViewer_utils_index.downloadFile(url);
    };
