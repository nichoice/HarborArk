...
var getScrollbarWidth = require('../../_chunks/dep-68f57f50.js');
var dom = require('../../_chunks/dep-a540990f.js');
var helper = require('../../_chunks/dep-8828ecbe.js');
var _arrayFilter = require('../../_chunks/dep-470fd721.js');
var isArrayLikeObject = require('../../_chunks/dep-08f1a433.js');
var _baseDifference = require('../../_chunks/dep-8f7a849d.js');
var _flatRest = require('../../_chunks/dep-86c7017f.js');
var _baseUniq = require('../../_chunks/dep-9a8df5c8.js');
var last = require('../../_chunks/dep-de8fe3e3.js');
...
function baseXor(arrays, iteratee, comparator) {
  ...
  if (length < 2) {
    return length ? _baseUniq.baseUniq(arrays[0]) : [];
  }
  var index = -1,
    result = Array(length);
  while (++index < length) {
  ...
  return _baseUniq.baseUniq(_flatRest.baseFlatten(result, 1), iteratee, comparator);
}
