...
var treeNode = require('./dep-7d10e34c.js');
var isFunction = require('./dep-fca60f44.js');
var isString = require('./dep-d108653b.js');
var isNumber = require('./dep-6281e9d2.js');
var configProvider_utils_context = require('./dep-93f95d13.js');
var isArray = require('./dep-bc6186ff.js');
var _baseDifference = require('./dep-8f7a849d.js');
var _flatRest = require('./dep-86c7017f.js');
var isArrayLikeObject = require('./dep-08f1a433.js');
var camelCase = require('./dep-6b73e8fe.js');
  ...
  return _createClass__default["default"](TreeStore, [{
    ...
    value: function getNodes(item, options) {
      ...
      if (options) {
        ...
        if (configProvider_utils_context.isPlainObject(conf.props)) {
          nodes = nodes.filter(function (node) {
...
//# sourceMappingURL=dep-5a8664b0.js.map
