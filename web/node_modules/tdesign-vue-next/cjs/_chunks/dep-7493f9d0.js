...
var constants = require('./dep-5a71b778.js');
  ...
  return _createClass__default["default"](Color, [{
    ...
    value: function object2color(object, format) {
      ...
      if (format === "RGB" || format === "RGBA") {
        return tinyColor__default["default"](object).toRgbString();
      }
      if (format === "HSL" || format === "HSLA") {
        return tinyColor__default["default"](object).toHslString();
      }
      if (format === "HSV" || format === "HSVA") {
        return tinyColor__default["default"](object).toHsvString();
      }
      return tinyColor__default["default"](object).toHexString();
    }
  }]);
}();
_Color = Color;
...
//# sourceMappingURL=dep-7493f9d0.js.map
